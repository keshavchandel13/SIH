...
export function DashboardSidebar() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-emerald-600 via-emerald-700 to-emerald-800 text-white">
      ...
      {/* Main Content Area with SAME gradient */}
      <div className="flex-1 p-8">
        <h1 className="text-3xl font-bold">Welcome to AyurDiet</h1>
        <p className="mt-4 text-white/80">
          Your personalized Ayurvedic diet recommendations will appear here.
        </p>
      </div>
    </div>
  );
